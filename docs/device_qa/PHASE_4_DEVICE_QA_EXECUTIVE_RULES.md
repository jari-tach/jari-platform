...
> **الحالة:** **CLOSED — PASS** (اعتماد المالك 2026-08-04) — انظر `PHASE_4_DEVICE_QA_CLOSURE_REPORT.md`  
> **التاجر:** محظور بالكامل حتى اكتمال المراحل 5→10 + موافقة المالك  
> **ملاحظة:** هذه القواعد تبقى مرجعًا تاريخيًا؛ العمل التشغيلي ينتقل لبوابة Performance ما لم يظهر Regression Device QA.
