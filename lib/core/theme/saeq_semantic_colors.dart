...
class SaeqSemanticColors extends ThemeExtension<SaeqSemanticColors> {
  ...
  /// Platform brand tokens (cream / green / gold) — display identity: jari Driver.
  static const SaeqSemanticColors light = SaeqSemanticColors(
    primary: Color(0xFF0F5B4E),
    primaryContainer: Color(0xFFE8F3ED),
    secondary: Color(0xFFD4A633),
    accent: Color(0xFFC4553A),
    background: Color(0xFFF7F3E9),
    surface: Color(0xFFFFFBF5),
    elevatedSurface: Color(0xFFFFFBF5),
    border: Color(0xFFCFC6B8),
    textPrimary: Color(0xFF18201D),
    textSecondary: Color(0xFF69736F),
    disabled: Color(0xFFB8C0BC),
    success: Color(0xFF2E7D32),
    successContainer: Color(0xFFE8F3ED),
    warning: Color(0xFFD4A633),
    warningContainer: Color(0xFFFBF4E6),
  ...
  /// Dark canvas aligned to platform charcoal / forest stub.
  static const SaeqSemanticColors dark = SaeqSemanticColors(
    primary: Color(0xFF0F5B4E),
    primaryContainer: Color(0xFF0A4339),
    secondary: Color(0xFFD4A633),
    accent: Color(0xFFC4553A),
    ...
    textPrimary: Color(0xFFF7F3E9),
    textSecondary: Color(0xFFB8C0BC),
    disabled: Color(0xFF757575),
    success: Color(0xFF81C784),
    successContainer: Color(0xFF0A4339),
    warning: Color(0xFFD4A633),
